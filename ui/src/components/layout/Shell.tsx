...
// Two top-level sections: real records (default '/') and synthetic drawings
// generated by scripts/generate_synthetic_drawings.py (under '/synthetic').
// The synthetic section is intentionally separate — its data is loosely tied
// to real houses but is staged for manual labeling, not production use.
